    ...
    return (
        <section id="experience" className="experience">
            <div className="experience__textarea">
                ...
                <p className="experience__textarea__paragraph">mais de 10 anos de atuando em<br />desenvolvimento front-end, com ênfase<br />nas tecnologias <span className="experience__textarea__paragraph-highlight">JavaScript</span> e <span className="experience__textarea__paragraph-highlight">React</span></p>
