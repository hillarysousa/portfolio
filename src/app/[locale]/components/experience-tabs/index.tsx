    ...
    return (
        <Tabs className="tabs" selectedTabClassName="tabs__tab-selected" >
            <TabList className="tabs__list">
                <Tab className="tabs__tab">{t("t:experience:tabs:first_tab:title")}</Tab>
                <Tab className="tabs__tab">{t("t:experience:tabs:second_tab:title")}</Tab>
                <Tab className="tabs__tab">{t("t:experience:tabs:third_tab:title")}</Tab>
            </TabList>

            <TabPanel className="tabs__tabpanel">
                <h3 className='tabs__tabpanel__title'>{t("t:experience:tabs:first_tab:subtitle")}</h3>
                <p className='tabs__tabpanel__period'>{t("t:experience:tabs:first_tab:period")}</p>
                <div className='tabs__tabpanel__content'>
                    <ul>
                        ...
                        <li>{t("t:experience:tabs:first_tab:topics:fourth")}</li>
                    </ul>
                </div>
            </TabPanel>

            <TabPanel className="tabs__tabpanel">
                <h3 className='tabs__tabpanel__title'>{t("t:experience:tabs:second_tab:subtitle")}</h3>
                <p className='tabs__tabpanel__period'>{t("t:experience:tabs:second_tab:period")}</p>
                <div className='tabs__tabpanel__content'>
                    <ul>
            ...
            <TabPanel className="tabs__tabpanel">
                <h3 className='tabs__tabpanel__title'>{t("t:experience:tabs:third_tab:subtitle")}</h3>
                <p className='tabs__tabpanel__period'>{t("t:experience:tabs:third_tab:period")}</p>
                <div className='tabs__tabpanel__content'>
                    <ul>
